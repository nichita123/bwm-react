      ...
      <Link className='rental-detail-link' to={`/rentals/${rental._id}`}>
        <div className="row">
          ...
          <div className="col-md-6">
            <h6 className={rental.category}>{rentalType(rental.shared)} {rental.category} &#183; {rental.city}</h6>
            <h4 className=''>{rental.title}</h4>
            <p className=''>${rental.dailyRate} per Night &#183; Free Cancelation</p>
          </div>
