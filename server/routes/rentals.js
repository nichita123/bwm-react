...
const updload = multer({ storage: storage, fileFilter: fileFilter });
...
router.post('/', UserCtrl.authMiddleware, updload.single('rentalImage'), function (req, res) {
  const { title, city, street, category, shared, bedrooms, description, dailyRate } = req.body;
